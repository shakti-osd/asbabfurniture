...
const DeliveryInformationPage = (props) => {
                        ...
                        <div className="row">
                            <div className="col-xs-12">
                                <div className="bradcaump__inner">
                                    ...
                                    <span className="breadcrumb-item active">Delivery Information</span>
                                    </nav>
                                </div>
                            </div>
                        </div>
...
export default connect(mapStateToProps)(DeliveryInformationPage)
